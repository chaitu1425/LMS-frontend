    ...
    return (
        <div className='min-h-screen flex items-center justify-center bg-gray-100 px-4'>
            ...
            {step == 1 && <div className='bg-white shadow-md rounded-xl p-8 max-w-md w-full'>
                ...
                <form className='space-y-40' onSubmit={(e)=>e.preventDefault()}>
                    <div>
                        <label htmlFor="email" className='block text-sm font-medium text-gray-700'>Enter Your Email</label>
                        <input type="email" id='email' className='mt-1 w-full px-4 py-2 border border-gray-300 rounded-md shadow-sw focus:outline-none focus:ring-2 focus:ring-[black]' placeholder='Your@example.com' required onChange={(e)=>{setEmail(e.target.value)}} value={email} />
                    </div>
            ...
            {step == 2 && <div className='bg-white shadow-md rounded-xl p-8 max-w-md w-full'>
                ...
                <form className='space-y-4 ' onSubmit={(e)=>e.preventDefault()}>
                    <div>
                        ...
                        <input type="text" id='otp' className='mt-1 w-full px-4 py-2 border border-gray-300 rounded-md shadow-sw focus:outline-none focus:ring-2 focus:ring-[black]' placeholder='* * * *'  required onChange={(e)=>setOtp(e.target.value)} value={otp} />
                    </div>
            ...
            {step == 3 && <div className='bg-white shadow-md rounded-xl p-8 max-w-md w-full'>
                ...
                <form className='space-y-4' onSubmit={(e)=>e.preventDefault()}>
                    <div>
                        ...
                        <input type="text" id='password' className='mt-1 w-full px-4 py-2 border border-gray-300 rounded-md shadow-sw focus:outline-none focus:ring-2 focus:ring-[black]' placeholder='*********'  required onChange={(e)=>setNewPassword(e.target.value)} value={newpassword} />
                    </div>
                    <div>
                        <label htmlFor="confirmpassword" className='block text-sm font-medium text-gray-700'>Confirm Password</label>
                        <input type="text" id='confirmpassword' className='mt-1 w-full px-4 py-2 border border-gray-300 rounded-md shadow-sw focus:outline-none focus:ring-2 focus:ring-[black]' placeholder='*********'  required onChange={(e)=>setConPassword(e.target.value)}  value={conpassword}/>
                    </div>
